...
const user1 = new User("Ivan", "Cecchi", 27, "Milano");
const user2 = new User("Dwayne", "Johnson", 55, "Roma");
const user3 = new User("Ash", "Ketchum", 86, "Bologna");
const user4 = new User("Tony", "Stark", 71, "Zocca");
const user5 = new User("Francesco", "Totti", 78, "Ramacca");
user1.ages();
user2.ages();
user3.ages();
user4.ages();
